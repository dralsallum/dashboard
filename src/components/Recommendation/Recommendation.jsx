...
const infoBreaks = [
  ...
  },
  {
    ...
    content:
      "خلال النوم العميق، يُفرز الجسم هرمون النمو الذي يُصلح الخلايا التالفة ويُعيد بناء الأنسجة. قلة النوم ترفع مستويات الكورتيزول والالتهاب، وهما من أبرز محركات الشيخوخة المبكرة.",
