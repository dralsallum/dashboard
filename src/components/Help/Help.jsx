...
const Help = () => {
  ...
  const faqData = [
    {
      question: "كيف أقوم بإنشاء حساب في وقتنا؟",
      answer:
    ...
    },
    {
      ...
      answer:
        "إذا كان حسابك مقفلاً، يمكنك التواصل مع فريق الدعم عبر البريد الإلكتروني support@waqtna.com أو استخدام خيار 'نسيت كلمة المرور' لإعادة تعيين بياناتك.",
    },
    {
    ...
    {
      question: "ما هي خيارات الجنس المتاحة في وقتنا؟",
      answer:
        "يوفر وقتنا مجموعة شاملة من خيارات الجنس والهوية لضمان الشمولية والاحترام لجميع المستخدمين. يمكنك اختيار الخيار المناسب لك في إعدادات الحساب.",
    },
    {
    ...
    {
      question: "كيف أقوم بتسجيل الدخول إلى وقتنا؟",
      answer:
