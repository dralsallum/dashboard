...
const Row = styled.div`
  ...
  &::before {
    right: 0;
    background: linear-gradient(to left, #f0f5f3 0%, transparent 100%);
  }

  &::after {
    left: 0;
    background: linear-gradient(to right, #f0f5f3 0%, transparent 100%);
  }
`;
...
const Card = styled.div`
  background: #f0f5f3;
  border-radius: 20px;
  border: 1px solid rgba(160, 200, 185, 0.7);
  box-shadow:
    0 2px 0px rgba(255, 255, 255, 0.9) inset,
    0 12px 40px rgba(20, 50, 40, 0.1),
    0 2px 8px rgba(20, 50, 40, 0.06);
